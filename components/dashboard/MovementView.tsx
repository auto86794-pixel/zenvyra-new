...
export const workoutLibrary: Workout[] = [
  {
    ...
    steps: [
      "Váll- és nyakkörzés",
      "Macska–tehén átmozgatás",
      "Csípőmobilizálás",
      "Lassú teljes testes nyújtás",
    ],
  },
  {
    id: "gentle-core",
  ...
  },
  {
    ...
    steps: [
      "Guggolás",
      "Kitörés hátra",
      "Fekvőtámasz választott verzióban",
  ...
  },
  {
    ...
    level: "Haladó",
    focus: "Erősítés",
    description: "Hosszabb, intenzívebb saját testsúlyos program gyakorlottabb napokra.",
    steps: [
      "Dinamikus bemelegítés",
      "Guggolás és térdemelés",
      "Kitörés váltott lábbal",
      "Fekvőtámasz",
      "Plank vállérintéssel",
      "Csípőemelés",
      "Törzserősítő blokk",
      "Lassú levezetés és nyújtás",
    ],
  },
  {
    id: "evening-release",
    ...
    <>
      <section className="movement-hero">
        <div>
          ...
          <p>
            Minden program eszköz nélkül végezhető. Nem a tökéletesség, hanem a
            rendszeres visszatérés számít.
          </p>
        </div>
